...
package humazed.github.com.autismkidsgame.draw.dao.impl;
...
import humazed.github.com.autismkidsgame.draw.db.JigsawDB;
import humazed.github.com.autismkidsgame.draw.model.ImageEntity;

import static humazed.github.com.autismkidsgame.draw.util.Base64Util.base64ToBitmap;
import static humazed.github.com.autismkidsgame.draw.util.DBUtil.ALL_COLUMNS;
import static humazed.github.com.autismkidsgame.draw.util.DBUtil.DESC_COLUMN;
import static humazed.github.com.autismkidsgame.draw.util.DBUtil.ID_COLUMN;
import static humazed.github.com.autismkidsgame.draw.util.DBUtil.ID_SELECTION;
import static humazed.github.com.autismkidsgame.draw.util.DBUtil.IMAGE_COLUMN;
import static humazed.github.com.autismkidsgame.draw.util.DBUtil.JIGSAW_TABLE;
import static humazed.github.com.autismkidsgame.draw.util.DBUtil.NAME_COLUMN;
import static humazed.github.com.autismkidsgame.draw.util.DBUtil.ORIGINAL_COLUMN;
import static humazed.github.com.autismkidsgame.draw.util.DBUtil.ORIGINAL_SELECTION;
import static humazed.github.com.autismkidsgame.draw.util.DBUtil.ORIGINAL_SELECTION_NULL;
import static humazed.github.com.autismkidsgame.draw.util.DBUtil.getIdArguments;
import static humazed.github.com.autismkidsgame.draw.util.EntityUtil.entityToContentValues;
