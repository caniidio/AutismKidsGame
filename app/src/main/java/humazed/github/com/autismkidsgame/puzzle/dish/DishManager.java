...
//    }
    ...
    private void initMask() {
        ...
        rectWidth = DensityUtil.dip2px(App.getAppContext(), (float) DISH_WIDTH / mLevel);
        rectHeight = DensityUtil.dip2px(App.getAppContext(), (float) DISH_HEIGHT / mLevel);
        r = rectWidth / 4;
...
//        canvas.save();
    ...
    private Bitmap getMask() {
        int width = DensityUtil.dip2px(App.getAppContext(), (float) DISH_WIDTH);
        int height = DensityUtil.dip2px(App.getAppContext(), (float) DISH_HEIGHT);
